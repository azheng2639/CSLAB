...
class Graph
{
	...
	public void DiscoverVertex(int index)
	{
		verticies[index].discovered = true;
		for(Edge edge = verticies[index].edge; edge != null; edge = edge.next)
		{
				if(!verticies[edge.target].discovered)
